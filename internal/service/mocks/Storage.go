...
// ValidateUser provides a mock function with given fields: _a0
func (_m *Storage) ValidateUser(_a0 models.UserLogin) (string, error) {
	ret := _m.Called(_a0)
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(models.UserLogin) (string, error)); ok {
		return rf(_a0)
	}
	if rf, ok := ret.Get(0).(func(models.UserLogin) string); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(string)
	}
